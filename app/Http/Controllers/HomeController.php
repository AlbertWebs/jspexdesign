...
class HomeController extends Controller
{
    public function index(){
        ...
        SEOMeta::setDescription('Jspex design is a creative studio dedicated to 3D space design consulting, planning and implementation provider based in Nairobi and operating within Kenya.');
        SEOMeta::setCanonical(''.url('/').'');

        OpenGraph::setDescription('Jspex design is a creative studio dedicated to 3D space design consulting, planning and implementation provider based in Nairobi and operating within Kenya.');
        ...
        JsonLd::setDescription('Jspex design is a creative studio dedicated to 3D space design consulting, planning and implementation provider based in Nairobi and operating within Kenya.');
        JsonLd::addImage('https://jspexdesign.com/img/logo.jpg');
