...
<head>
  ...
  <link rel="stylesheet" href="{{asset('theme/css/theme-dark.css')}}">
</head>
...
<body class="webpage">
  ...
  <script src="{{asset('theme/js/jquery.pagepiling.js')}}"></script>
  <script src="{{asset('theme/js/aos.js')}}"></script>
  <script src="{{asset('theme/js/jquery.easy_number_animate.js')}}"></script>
  <script src="{{asset('theme/js/isotope.pkgd.min.js')}}"></script>
  <script src="{{asset('theme/js/packery-mode.pkgd.min.js')}}"></script>
